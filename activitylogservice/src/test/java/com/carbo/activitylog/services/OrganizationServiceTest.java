...
class OrganizationServiceTest {
    ...
    @Test
    void testSave_InvalidOrganization() {
        organization.setName(null); // Invalid state
        // Assuming save would throw an exception on invalid organization; adjust based on actual validation logic if present
        // Uncomment below line if a specific exception type is expected
        // assertThrows(IllegalArgumentException.class, () -> organizationService.save(organization));
    }
}