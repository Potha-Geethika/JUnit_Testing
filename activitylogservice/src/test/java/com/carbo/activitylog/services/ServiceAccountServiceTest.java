...
class ServiceAccountServiceTest {
    ...
    @Test
    void testGetByOrganizationIdWithNull() {
        List<ServiceAccount> result = serviceAccountService.getByOrganizationId(null);
        assertNotNull(result);
    ...
    @Test
    void testSave() {
        when(serviceAccountMongoDbRepository.save(any(ServiceAccount.class))).thenReturn(serviceAccount);
    ...
    void testDelete() {
        ...
        verify(serviceAccountMongoDbRepository).deleteById("1");
    }
}