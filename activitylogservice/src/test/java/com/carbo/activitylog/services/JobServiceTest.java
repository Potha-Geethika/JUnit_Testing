...
class JobServiceTest {
    ...
    @Test
    void testGetByOrganizationId_NullOrganizationId() {
        List<Job> result = jobService.getByOrganizationId(null);
        assertNotNull(result);
        assertEquals(0, result.size());
    }
    ...
    void testGetByOrganizationIdAndJobId_HappyPath() {
        ...
        when(jobMongoDbRepository.findByOrganizationIdAndId(organizationId, jobId))
                .thenReturn(Collections.singletonList(expectedJob));
    ...
    @Test
    void testGetByOrganizationIdAndJobId_EmptyList() {
        String organizationId = "org123";
        String jobId = "job123";
        when(jobMongoDbRepository.findByOrganizationIdAndId(organizationId, jobId))
    ...
    @Test
    void testGetByOrganizationIdAndJobId_NullOrganizationId() {
        String jobId = "job123";
        Optional<Job> result = jobService.getByOrganizationIdAndJobId(null, jobId);
        assertNotNull(result);
        assertEquals(Optional.empty(), result);
    }
    ...
    @Test
    void testGetJobByJobNumber_NullJobNumber() {
        List<Job> result = jobService.getJobByJobNumber(null);
        assertNotNull(result);
        assertEquals(0, result.size());
    }
    ...
    @Test
    void testFindByJobId_NullJobId() {
        Optional<Job> result = jobService.findByJobId(null);
        assertNotNull(result);
        assertEquals(Optional.empty(), result);
    }
}